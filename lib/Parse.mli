...
(**
    Functions for parsing sml programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a sml program from a string into a typed OCaml CST.
...
(** Parse a sml program from a file into a typed OCaml CST.
